...
public class EnemyFunctions {
    public static class MoveRandomly implements BiFunction<Enemy, List<Entity>, List<Point>> {
        @Override
        public List<Point> apply(Enemy enemy, List<Entity> entities) {
    ...
    public static class FollowHero implements BiFunction<Enemy, List<Entity>, List<Point>> {
        @Override
        public List<Point> apply(Enemy enemy, List<Entity> entities) {
            Character hero = ((Character)entities.stream()
                    .filter(ent -> ent instanceof Character)
        ...
        private List<Point> breadthFirstSearch(Point startingPosition, Point goal, List<Entity> obstacles) {
